...
((HttpServer2) => {
  HttpServer2.createConfig = /* @__PURE__ */ __name((path) => import_core2.Schema.object({
    protocol: import_core2.Schema.const("http").required(),
...
((WsClient2) => {
  WsClient2.Options = import_core3.Schema.intersect([
    import_core3.Schema.object({
      protocol: import_core3.Schema.const("ws")
    }),
...
((LarkBot2) => {
  LarkBot2.Config = import_core6.Schema.intersect([
    import_core6.Schema.object({
      ...
      encryptKey: import_core6.Schema.string().role("secret").description("机器人的 Encrypt Key。"),
      verificationToken: import_core6.Schema.string().description("事件推送的验证令牌。")
    }),
    import_core6.Schema.union([
      import_core6.Schema.intersect([
        ...
        import_core6.Schema.object({
          protocol: process.env.KOISHI_ENV === "browser" ? import_core6.Schema.const("ws").default("ws") : import_core6.Schema.union(["http", "ws"]).description("选择要使用的协议。").default("ws")
        }),
        import_core6.Schema.union([
