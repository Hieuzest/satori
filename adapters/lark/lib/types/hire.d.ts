...
export declare namespace Hire {
    ...
    namespace Job {
        ...
        const enum CombinedCreateRequestExperience {
            /** 不限 */
            NoLimit = 1,
            /** 应届毕业生 */
            Graduate = 2,
        ...
        const enum CombinedCreateRequestProcessType {
            /** 社招 */
            SocialProcess = 1,
            /** 校招 */
            CampusProcess = 2
        }
        const enum CombinedCreateRequestRequiredDegree {
            /** 小学及以上 */
            PrimaryEducation = 1,
            /** 初中及以上 */
        ...
        const enum CombinedCreateRequestJobAttribute {
            /** 实体职位 */
            Concrete = 1,
            /** 虚拟职位 */
            Virtual = 2
        ...
        const enum CombinedUpdateRequestExperience {
            /** 不限 */
            NoLimit = 1,
            /** 应届毕业生 */
            Graduate = 2,
        ...
        const enum CombinedUpdateRequestRequiredDegree {
            /** 小学及以上 */
            PrimaryEducation = 1,
            /** 初中及以上 */
            JuniorMiddleSchoolEducation = 2,
        ...
        const enum CombinedUpdateRequestJobAttribute {
            /** 实体职位 */
            Concrete = 1,
            /** 虚拟职位 */
            Virtual = 2
        ...
        interface CombinedUpdateResponse {
            /** 职位广告 */
            default_job_post?: Lark.CombinedJobResultDefaultJobPost;
            /** 职位 */
            job?: Lark.Job;
        ...
        namespace Manager {
            ...
            const enum BatchUpdateRequestUpdateOption {
                /** 招聘负责人 */
                JobManager = 1,
                /** 招聘协助人 */
                Assistant = 2,
    ...
    namespace JobRequirement {
        ...
        const enum CreateRequestDisplayProgress {
            /** 待启动 */
            WaitingStart = 1,
            /** 进行中 */
            OnGoing = 2,
        ...
        const enum CreateRequestCategory {
            /** 新增 */
            Addition = 1,
            /** 替换 */
            Replacement = 2
        }
        const enum CreateRequestPriority {
            /** 高 */
            High = 1,
            /** 中 */
            Medium = 2,
        ...
        const enum CreateRequestRequiredDegree {
            /** 小学及以上 */
            PrimaryEducation = 1,
            /** 初中及以上 */
            JuniorMiddleSchoolEducation = 2,
        ...
        const enum CreateRequestProcessType {
            /** 社招 */
            Social = 1,
            /** 校招 */
            Campus = 2
        ...
        const enum UpdateRequestDisplayProgress {
            /** 待启动 */
            WaitingStart = 1,
            /** 进行中 */
            OnGoing = 2,
        ...
        const enum UpdateRequestCategory {
            /** 新增 */
            Addition = 1,
            /** 替换 */
            Replacement = 2
        }
        const enum UpdateRequestPriority {
            /** 高 */
            High = 1,
            /** 中 */
            Medium = 2,
        ...
        const enum UpdateRequestRequiredDegree {
            /** 小学及以上 */
            PrimaryEducation = 1,
            /** 初中及以上 */
            JuniorMiddleSchoolEducation = 2,
        ...
        const enum UpdateRequestProcessType {
            /** 社招 */
            Social = 1,
            /** 校招 */
            Campus = 2
    ...
    namespace JobRequirementSchema {
        interface Methods {
            /**
             * 获取招聘需求模板列表
    ...
    namespace InterviewFeedbackForm {
        interface Methods {
            /**
             * 获取面试评价表列表
    ...
    namespace InterviewRegistrationSchema {
        interface Methods {
            /**
             * 获取面试登记表列表
    ...
    namespace Interviewer {
        ...
        const enum ListQueryVerifyStatus {
            NotVarified = 1,
            Varified = 2
        }
        interface ListQuery extends Pagination {
    ...
    namespace OfferApplicationForm {
        interface Methods {
            /**
             * 获取 Offer 申请表信息
    ...
    namespace Referral {
        ...
        interface GetByApplicationQuery {
            /** 投递的 ID */
            application_id: string;
            /** 此次调用中使用的用户ID的类型 */
            user_id_type?: 'user_id' | 'union_id' | 'open_id' | 'people_admin_id';
        }
        interface GetByApplicationResponse {
            /** 内推信息 */
            referral?: Lark.Referral;
        }
    }
    namespace ReferralWebsite {
        interface Methods {
        ...
        namespace JobPost {
            ...
            const enum ListQueryProcessType {
                /** 社招 */
                SocialProcess = 1,
                /** 校招 */
                CampusProcess = 2
    ...
    namespace Website {
        ...
        namespace Delivery {
            ...
            interface CreateByResumeRequest {
                /** 职位广告 ID */
                job_post_id: string;
                /** 人才信息 */
            ...
            interface CreateByResumeQuery {
                /** 此次调用中使用的用户ID的类型 */
                user_id_type?: 'user_id' | 'union_id' | 'open_id';
            }
            interface CreateByResumeResponse {
                delivery?: Lark.WebsiteDeliveryDto;
            }
            interface CreateByAttachmentRequest {
                /** 职位广告 ID */
                job_post_id: string;
                /** 官网用户 ID */
                user_id: string;
            ...
            interface CreateByAttachmentResponse {
                /** 异步任务 ID */
                task_id?: string;
            }
        }
        namespace DeliveryTask {
            interface Methods {
                /**
                 * 获取招聘官网投递任务结果
    ...
    namespace Agency {
        ...
        interface ProtectSearchRequest {
            /** 人才id */
            talent_id: string;
        }
        interface ProtectSearchResponse {
            /** 是否已入职 */
        ...
        const enum GetAgencyAccountRequestStatus {
            /** 正常 */
            Normal = 0,
            /** 已禁用 */
            Enabled = 1,
        ...
        const enum GetAgencyAccountRequestRole {
            /** 管理员 */
            Manager = 0,
            /** 顾问 */
            Consultant = 1
        }
        interface GetAgencyAccountRequest {
            /** 猎头供应商 ID */
            supplier_id: string;
            /** 猎头状态 */
        ...
        interface GetAgencyAccountQuery extends Pagination {
            /** 此次调用中使用的用户ID的类型 */
        ...
        const enum OperateAgencyAccountRequestOption {
            /** 禁用 */
            Add = 1,
            /** 取消禁用 */
            Remove = 2
        }
        interface OperateAgencyAccountRequest {
            /** 操作类型 */
    ...
    namespace Talent {
        ...
        interface RemoveToFolderRequest {
            /** 人才 ID 列表 */
            talent_id_list: string[];
            /** 文件夹 ID */
            folder_id: string;
        }
        interface RemoveToFolderResponse {
            /** 人才 ID 列表 */
            talent_id_list?: string[];
            /** 文件夹 ID */
            folder_id?: string;
        ...
        const enum OnboardStatusRequestOperation {
            /** 入职 */
            Onboard = 1,
            /** 离职 */
            Overboard = 2
        }
        interface OnboardStatusRequest {
            /** 操作类型 1:入职 2:离职 */
    ...
    namespace ExternalApplication {
        ...
        const enum CreateRequestJobRecruitmentType {
            /** 社招 */
            SocialRecruitment = 1,
            /** 校招 */
            CampusRecruitment = 2
        }
        const enum CreateRequestDeliveryType {
            /** HR 寻访 */
            HRVisit = 1,
            /** 候选人主动投递 */
            CandidateDelivery = 2,
        ...
        const enum UpdateRequestJobRecruitmentType {
            /** 社招 */
            SocialRecruitment = 1,
            /** 校招 */
            CampusRecruitment = 2
        }
        const enum UpdateRequestDeliveryType {
            /** HR 寻访 */
            HRVisit = 1,
            /** 候选人主动投递 */
            CandidateDelivery = 2,
    ...
    namespace ExternalInterview {
        ...
        const enum CreateRequestParticipateStatus {
            /** 未参与 */
            NotStart = 1,
            /** 参与 */
            Participated = 2,
        ...
        const enum UpdateRequestParticipateStatus {
            /** 未参与 */
            NotStart = 1,
            /** 参与 */
            Participated = 2,
    ...
    namespace ExternalInterviewAssessment {
        interface Methods {
            /**
             * 创建外部面评
        ...
        const enum CreateRequestConclusion {
            /** 不通过 */
            Fail = 1,
            /** 通过 */
            Pass = 2,
        ...
        const enum PatchRequestConclusion {
            /** 不通过 */
            Fail = 1,
            /** 通过 */
            Pass = 2,
    ...
    namespace ExternalBackgroundCheck {
        interface Methods {
            /**
             * 创建外部背调
    ...
    namespace ExternalReferralReward {
        interface Methods {
            /**
             * 导入外部内推奖励
        ...
        const enum CreateRequestRuleType {
            /** 入职奖励，候选人入职或转正后产生的奖励 */
            Onboard = 1,
    ...
    namespace TalentPool {
        ...
        const enum BatchChangeTalentPoolRequestOptionType {
            /** 加入人才库操作 */
            Add = 1,
            /** 从指定人才库移除 */
            Remove = 2
        }
        interface BatchChangeTalentPoolRequest {
            /** 人才 ID 列表 */
            talent_id_list: string[];
            /** 操作类型 */
        ...
        const enum MoveTalentRequestAddType {
            /** 仅加入指定人才库 */
            OnlyAdd = 1,
            /** 加入指定人才库并从所有原库移除 */
            AddAndRemoveFromOrigin = 2
        }
        interface MoveTalentRequest {
            /** 人才ID */
            talent_id: string;
            /** 操作类型 */
            add_type: MoveTalentRequestAddType;
        }
        interface MoveTalentResponse {
            /** 人才库ID */
    ...
    namespace TalentBlocklist {
        ...
        const enum ChangeTalentBlockRequestOption {
            /** 加入屏蔽名单操作 */
            Add = 1,
            /** 从屏蔽名单中移除 */
            Remove = 2
        }
        interface ChangeTalentBlockRequest {
            /** 人才 ID */
            talent_id: string;
            /** 操作类型 */
    ...
    namespace Application {
        ...
        interface TransferStageRequest {
        ...
        interface TransferOnboardRequest {
            /** 实际入职时间 */
        ...
        interface TransferOnboardQuery {
            /** 用户 ID 类型 */
            user_id_type?: 'user_id' | 'union_id' | 'open_id';
            /** 此次调用中使用的部门 ID 的类型 */
            department_id_type?: 'open_department_id' | 'department_id' | 'people_admin_department_id';
        ...
        interface TransferOnboardResponse {
            /** employee */
            employee?: Lark.Employee;
        }
        interface CancelOnboardRequest {
            /** 终止类型 */
            termination_type: 1 | 22 | 27;
            /** 终止原因 ID 列表 */
    ...
    namespace Interview {
        ...
        interface GetByTalentResponse {
            /** 投递面试列表 */
            items?: Lark.TalentInterview[];
        }
    }
    namespace InterviewRecord {
        interface Methods {
            attachment: Attachment.Methods;
            /**
             * 获取面试评价详细信息（新版）
    ...
    namespace Offer {
        ...
        const enum OfferStatusRequestOfferStatus {
            /** Offer 审批中 */
            Approving = 2,
            /** Offer 审批已撤回 */
            Withdrawn = 3,
        ...
        interface InternOfferStatusRequest {
            /** 更新入/离职状态的操作 */
        ...
        interface InternOfferStatusResponse {
            /** Offer ID */
            offer_id?: string;
            /** 更新入/离职状态的操作 */
            operation: 'confirm_onboarding' | 'cancel_onboarding' | 'offboard';
    ...
    namespace BackgroundCheckOrder {
        interface Methods {
            /**
             * 获取背调信息列表
    ...
    namespace Employee {
        ...
        const enum PatchRequestOperation {
            /** 转正 */
            Convert = 1,
            /** 离职 */
            Overboard = 2
    ...
    namespace Note {
        ...
        const enum CreateRequestPrivacy {
            /** 私密 */
            Private = 1,
            /** 公开 */
            Public = 2
    ...
    namespace EcoAccountCustomField {
        interface Methods {
            /**
             * 创建账号自定义字段
    ...
    namespace EcoBackgroundCheckCustomField {
        interface Methods {
            /**
             * 创建背调自定义字段
    ...
    namespace EcoBackgroundCheckPackage {
        interface Methods {
            /**
             * 创建背调套餐和附加调查项
    ...
    namespace ReferralAccount {
        ...
        interface GetAccountAssetsQuery {
            /** 账户 ID */
            referral_account_id: string;
            /** 此次调用中使用的用户ID的类型 */
            user_id_type?: 'user_id' | 'union_id' | 'open_id';
        }
        interface GetAccountAssetsResponse {
            /** 账户信息 */
            account?: Lark.Account;
        }
        interface CreateRequest {
        ...
        const enum WithdrawRequestWithdrawBonusType {
            /** 积分 */
            Point = 1,
            /** 现金 */
            Cash = 2
    ...
    namespace OfferSchema {
        ...
        const enum GetResponseScenario {
            /** Offer审批表 */
            ApplyOffer = 1
        }
        interface GetResponse {
