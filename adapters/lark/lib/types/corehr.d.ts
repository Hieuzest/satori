...
export declare namespace Corehr {
    interface Methods {
    ...
    namespace CustomField {
        ...
        interface GetByParamQuery {
            /** 所属对象 apiname */
            object_api_name: string;
            /** 自定义字段 apiname */
            custom_api_name: string;
        }
        interface GetByParamResponse {
            /** 自定义字段详情 */
    ...
    namespace CommonData {
        ...
        namespace MetaData {
            ...
            interface AddEnumOptionQuery {
                /** 根据 client_token 是否一致来判断是否为同一请求 */
                client_token?: string;
            }
            interface AddEnumOptionResponse {
                /** 枚举字段 API name */
                enum_field_api_name?: string;
                /** 枚举全部选项列表 */
                enum_field_options?: Lark.EnumFieldOption[];
            ...
            interface EditEnumOptionQuery {
                /** 根据 client_token 是否一致来判断是否为同一请求 */
                client_token?: string;
            }
            interface EditEnumOptionResponse {
                /** 枚举字段 API name */
                enum_field_api_name?: string;
                /** 枚举全部选项列表 */
                enum_field_options?: Lark.EnumFieldOption[];
        ...
        namespace Id {
            ...
            const enum ConvertQueryIdTransformType {
                /** 飞书人事 -> 飞书通讯录 */
                CoreHR2Feishu = 1,
                /** 飞书通讯录 -> 飞书人事 */
                Feishu2CoreHR = 2,
    ...
    namespace BasicInfo {
        ...
        namespace CountryRegion {
            ...
            const enum SearchRequestStatus {
                /** 生效 */
                Active = 1,
                /** 失效 */
                Inactive = 0
        ...
        namespace CountryRegionSubdivision {
            interface Methods {
                /**
                 * 查询省份/主要行政区信息
    ...
    namespace Employees {
        ...
        namespace AdditionalJob {
            ...
            interface BatchQuery extends Pagination {
                /** 用户 ID 类型 */
                user_id_type?: 'user_id' | 'union_id' | 'open_id' | 'people_corehr_id';
                /** 此次调用中使用的部门 ID 类型 */
                department_id_type?: 'open_department_id' | 'department_id' | 'people_corehr_department_id';
    ...
    namespace DefaultCostCenter {
        ...
        interface UpdateVersionQuery {
            /** 幂等标识，服务端会忽略client_token重复的请求 */
            client_token?: string;
            /** 用户 ID 类型 */
            user_id_type?: 'user_id' | 'union_id' | 'open_id' | 'people_corehr_id';
        }
        interface RemoveVersionRequest {
            /** 员工雇佣 ID */
            employment_id: string;
            /** 成本中心信息 */
            default_cost_center?: Lark.EmploymentDefaultCostCenter;
        }
        interface RemoveVersionQuery {
            /** 幂等标识，服务端会忽略client_token重复的请求 */
            client_token?: string;
            /** 用户 ID 类型 */
            user_id_type?: 'user_id' | 'union_id' | 'open_id' | 'people_corehr_id';
    ...
    namespace Department {
        ...
        interface QueryOperationLogsRequest {
            /** 部门ID列表 */
        ...
        interface QueryOperationLogsQuery extends Pagination {
            /** 此次调用中使用的部门 ID 类型 */
            department_id_type?: 'open_department_id' | 'department_id' | 'people_corehr_department_id';
        }
        interface QueryOperationLogsResponse {
            /** 操作日志列表 */
        ...
        interface ParentsRequest {
            /** 部门 ID 列表，一次性最多传入 100 个部门 ID */
            department_id_list: string[];
        }
        interface ParentsQuery {
            /** 此次调用中使用的部门 ID 类型 */
            department_id_type?: 'open_department_id' | 'department_id' | 'people_corehr_department_id';
        }
        ...
        interface QueryTimelineRequest {
            /** 部门 ID 列表 */
            department_ids: string[];
            /** 生效日期 */
        ...
        interface QueryTimelineQuery {
            /** 用户 ID 类型 */
            user_id_type?: 'user_id' | 'union_id' | 'open_id' | 'people_corehr_id';
            /** 此次调用中使用的部门 ID 类型 */
            department_id_type?: 'open_department_id' | 'department_id' | 'people_corehr_department_id';
        }
        interface QueryTimelineResponse {
            /** 部门信息 */
        ...
        interface TreeQuery extends Pagination {
            /** 此次调用中使用的部门 ID 类型 */
            department_id_type?: 'open_department_id' | 'department_id' | 'people_corehr_department_id';
        }
        ...
        interface QueryMultiTimelineQuery extends Pagination {
            /** 用户 ID 类型 */
            user_id_type?: 'user_id' | 'union_id' | 'open_id' | 'people_corehr_id';
            /** 此次调用中使用的部门 ID 类型 */
            department_id_type?: 'open_department_id' | 'department_id' | 'people_corehr_department_id';
    ...
    namespace ApprovalGroups {
        ...
        interface OpenQueryDepartmentChangeListByIdsRequest {
            /** 部门调整记录 ID List */
            department_change_ids?: string[];
            /** 是否返回部门全路径 */
            need_department_path?: boolean;
        }
        interface OpenQueryDepartmentChangeListByIdsQuery {
            /** 组织架构调整流程 ID */
            process_id: string;
            /** 用户 ID 类型 */
            user_id_type?: 'user_id' | 'union_id' | 'open_id' | 'people_corehr_id';
        ...
        interface OpenQueryDepartmentChangeListByIdsResponse {
            /** 部门调整记录信息列表 */
            department_changes?: Lark.DepartmentChange[];
        }
        interface OpenQueryJobChangeListByIdsRequest {
            /** 人员异动记录 ID List */
            job_change_ids?: string[];
            /** 是否返回部门全路径 */
            need_department_path?: boolean;
        }
        interface OpenQueryJobChangeListByIdsQuery {
            /** 组织架构调整流程 ID */
            process_id: string;
            /** 用户 ID 类型 */
            user_id_type?: 'user_id' | 'union_id' | 'open_id' | 'people_corehr_id';
        ...
        interface OpenQueryJobChangeListByIdsResponse {
            /** 人员异动记录信息列表 */
    ...
    namespace PreHire {
        ...
        interface WithdrawOnboardingRequest {
            /** 待入职ID，可从待入职列表接口获取 */
            pre_hire_id: string;
            /** 撤销原因 */
            withdraw_reason: string;
        }
        interface WithdrawOnboardingResponse {
            /** 是否成功撤销入职 */
            success?: boolean;
        }
        interface RestoreFlowInstanceRequest {
            /** 待入职ID，可从待入职列表接口获取 */
            pre_hire_id: string;
            /** 是否强制占编；true为强制占编；false为非强制占编 */
            confirm_workforce?: boolean;
        }
        interface RestoreFlowInstanceResponse {
            /** 是否成功恢复入职 */
            success?: boolean;
        }
        interface CreateRequest {
        ...
        interface TransitTaskRequest {
            /** 系统预置的职位信息和个人信息任务的task_id分别为1和2，自定义任务的task_id是一串UUID */
            task_id: string;
        }
        interface TransitTaskResponse {
            /** 是否成功流转任务 */
            success?: boolean;
        }
    ...
    namespace JobChange {
        ...
        const enum CreateRequestTransferMode {
            /** 直接异动 */
            Type1 = 1,
            /** 发起异动 */
            Type2 = 2
    ...
    namespace Offboarding {
        ...
        const enum SubmitV2RequestOffboardingMode {
            /** 直接离职 */
            TerminationOfDismissal = 1,
            /** 发起离职审批 */
            OffboardingWithProcess = 2
        }
        interface SubmitV2Request {
            /** 离职方式 */
        ...
        const enum SubmitRequestOffboardingMode {
            /** 直接离职 */
            TerminationOfDismissal = 1
        }
        interface SubmitRequest {
    ...
    namespace WorkforcePlanDetailRow {
        interface Methods {
            /**
             * 批量创建/更新明细行
    ...
    namespace Leave {
        ...
        interface LeaveBalancesQuery extends Pagination {
        ...
        interface LeaveRequestHistoryQuery extends Pagination {
            /** 员工 ID 列表，最大 100 个（不传则默认查询全部员工） */
            employment_id_list?: string[];
        ...
        interface CalendarByScopeResponse {
            /** 工作日历id */
            calendar_wk_id?: string;
        }
        interface WorkCalendarDateRequest {
            /** 工作日历WKID列表，最多100 */
            wk_calendar_ids: string[];
        ...
        interface WorkCalendarDateResponse {
            /** 日期类型列表 */
    ...
    namespace Authorization {
        ...
        interface AddRoleAssignResponse {
            /** 授权id */
            assign_id?: string;
        }
        interface UpdateRoleAssignRequest {
            /** 授权 */
            assigned_organization_items: Lark.AssignedOrganizationWithCode[][];
        }
        interface UpdateRoleAssignQuery {
            /** 雇员 ID */
            employment_id: string;
            /** 用户 ID 类型 */
            user_id_type?: 'user_id' | 'union_id' | 'open_id' | 'people_corehr_id';
        ...
        interface UpdateRoleAssignResponse {
            /** 授权id */
            assign_id?: string;
        }
        interface RemoveRoleAssignQuery {
            /** 雇员 ID */
            employment_id: string;
            /** 用户 ID 类型 */
            user_id_type?: 'user_id' | 'union_id' | 'open_id' | 'people_corehr_id';
        ...
        interface RemoveRoleAssignResponse {
            /** 授权id */
            assign_id?: string;
        }
    }
    ...
    namespace Bp {
        ...
        interface GetByDepartmentRequest {
            /** 部门 ID */
            department_id: string;
        }
        interface GetByDepartmentQuery {
            /** 用户 ID 类型 */
            user_id_type?: 'user_id' | 'union_id' | 'open_id' | 'people_corehr_id';
            /** 此次调用中使用的部门 ID 类型 */
            department_id_type?: 'open_department_id' | 'department_id' | 'people_corehr_department_id';
        }
        interface GetByDepartmentResponse {
    ...
    namespace Process {
        ...
        const enum GetResponseProperties {
            /** 普通流程 */
            Common = 1,
            /** 撤销流程 */
            CheXiao = 2,
        ...
        namespace Approver {
            ...
            const enum UpdateRequestStatus {
                /** 拒绝 */
                Approved = 2,
                /** 通过 */
                Rejected = 3
        ...
        namespace Extra {
            ...
            const enum UpdateRequestExtraType {
                /** 前加签 */
                PreExtra = 0,
                /** 并加签 */
                CurrentExtra = 1,
            ...
            const enum UpdateRequestApprovalType {
                /** 或签 */
                OR = 0,
                /** 会签 */
                AND = 1
    ...
    namespace CompensationStandard {
        interface Methods {
            /**
             * 获取员工薪资标准
