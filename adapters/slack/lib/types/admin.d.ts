...
export declare namespace Admin {
    namespace Params {
        interface AppsApprove {
            app_id?: string;
            request_id?: string;
            team_id?: string;
        }
        interface AppsApprovedList {
            limit?: number;
            cursor?: string;
            team_id?: string;
            enterprise_id?: string;
        }
        interface AppsRequestsList {
            limit?: number;
            cursor?: string;
            team_id?: string;
        }
        interface AppsRestrict {
            app_id?: string;
            request_id?: string;
            team_id?: string;
        }
        interface AppsRestrictedList {
            limit?: number;
            cursor?: string;
            team_id?: string;
            enterprise_id?: string;
        }
        interface ConversationsArchive {
            channel_id: string;
        }
        interface ConversationsConvertToPrivate {
            channel_id: string;
        }
        ...
        interface ConversationsDelete {
            channel_id: string;
        }
        interface ConversationsDisconnectShared {
            channel_id: string;
            leaving_team_ids?: string;
        }
        interface ConversationsEkmListOriginalConnectedChannelInfo {
            channel_ids?: string;
            team_ids?: string;
            limit?: number;
            cursor?: string;
        }
        interface ConversationsGetConversationPrefs {
            channel_id: string;
        }
        interface ConversationsGetTeams {
            channel_id: string;
            cursor?: string;
            limit?: number;
        }
        interface ConversationsInvite {
            user_ids: string;
            channel_id: string;
        }
        interface ConversationsRename {
            channel_id: string;
            name: string;
        }
        interface ConversationsRestrictAccessAddGroup {
            team_id?: string;
            group_id: string;
            channel_id: string;
        }
        interface ConversationsRestrictAccessListGroups {
            channel_id: string;
            team_id?: string;
        }
        interface ConversationsRestrictAccessRemoveGroup {
            team_id: string;
            group_id: string;
            channel_id: string;
        }
        ...
        interface ConversationsSetConversationPrefs {
            channel_id: string;
            prefs: string;
        }
        interface ConversationsSetTeams {
            channel_id: string;
            team_id?: string;
            target_team_ids?: string;
            org_channel?: boolean;
        }
        interface ConversationsUnarchive {
            channel_id: string;
        }
        interface EmojiAdd {
            name: string;
        ...
        interface EmojiRemove {
            name: string;
        }
        interface EmojiRename {
            name: string;
            new_name: string;
        }
        interface InviteRequestsApprove {
            team_id?: string;
            invite_request_id: string;
        }
        interface InviteRequestsApprovedList {
            team_id?: string;
            cursor?: string;
            limit?: number;
        }
        interface InviteRequestsDeniedList {
            team_id?: string;
            cursor?: string;
            limit?: number;
        }
        interface InviteRequestsDeny {
            team_id?: string;
            invite_request_id: string;
        }
        interface InviteRequestsList {
            team_id?: string;
            cursor?: string;
            limit?: number;
        }
        interface TeamsAdminsList {
            limit?: number;
            cursor?: string;
            team_id: string;
        }
        interface TeamsCreate {
            team_domain: string;
            team_name: string;
        ...
        interface TeamsOwnersList {
            team_id: string;
            limit?: number;
            cursor?: string;
        }
        interface TeamsSettingsInfo {
            team_id: string;
        }
        interface TeamsSettingsSetDefaultChannels {
            team_id: string;
            channel_ids: string;
        }
        interface TeamsSettingsSetDescription {
            team_id: string;
            description: string;
        }
        interface TeamsSettingsSetDiscoverability {
            team_id: string;
            discoverability: string;
        }
        interface TeamsSettingsSetIcon {
            image_url: string;
            team_id: string;
        }
        interface TeamsSettingsSetName {
            team_id: string;
            name: string;
        }
        interface UsergroupsAddChannels {
            usergroup_id: string;
            team_id?: string;
            channel_ids: string;
        }
        interface UsergroupsAddTeams {
            usergroup_id: string;
            team_ids: string;
            auto_provision?: boolean;
        }
        interface UsergroupsListChannels {
            usergroup_id: string;
            team_id?: string;
            include_num_members?: boolean;
        }
        interface UsergroupsRemoveChannels {
            usergroup_id: string;
            channel_ids: string;
        }
        interface UsersAssign {
            team_id: string;
            user_id: string;
        ...
        interface UsersRemove {
            team_id: string;
            user_id: string;
        }
        interface UsersSessionInvalidate {
            team_id: string;
            session_id: number;
        }
        interface UsersSessionReset {
            user_id: string;
            mobile_only?: boolean;
            web_only?: boolean;
        }
        interface UsersSetAdmin {
            team_id: string;
            user_id: string;
        }
        interface UsersSetExpiration {
            team_id: string;
            user_id: string;
            expiration_ts: number;
        }
        interface UsersSetOwner {
            team_id: string;
            user_id: string;
        }
        interface UsersSetRegular {
            team_id: string;
            user_id: string;
        }
    }
