 ...
 */
export type SlackEvent = ChannelArchiveEvent | ChannelCreatedEvent | ChannelDeletedEvent | ChannelIDChangedEvent | ChannelLeftEvent | ChannelRenameEvent | EmojiChangedEvent | FileChangeEvent | InviteRequestedEvent | MemberJoinedChannelEvent | MemberLeftChannelEvent | MessageEvent | ReactionAddedEvent | ReactionRemovedEvent | UserChangeEvent | UserProfileChangedEvent | UserStatusChangedEvent | HelloEvent;
