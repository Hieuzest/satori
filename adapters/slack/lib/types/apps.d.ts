...
export declare namespace Apps {
    namespace Params {
        interface EventAuthorizationsList {
        ...
        interface PermissionsResourcesList {
            cursor?: string;
            limit?: number;
        }
        interface PermissionsScopesList {
        }
        interface PermissionsUsersList {
            cursor?: string;
            limit?: number;
        }
        interface PermissionsUsersRequest {
            scopes: string;
            trigger_id: string;
            user: string;
        }
