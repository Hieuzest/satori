...
var Signal = /* @__PURE__ */ ((Signal2) => {
  ...
  Signal2[Signal2["resume"] = 4] = "resume";
  Signal2[Signal2["reconnect"] = 5] = "reconnect";
  Signal2[Signal2["resumeAck"] = 6] = "resumeAck";
  return Signal2;
})(Signal || {});
...
var WsClient = class extends import_core2.Adapter.WsClient {
  ...
  async accept() {
    this._sn = 0;
    this._hello = setTimeout(() => this.socket?.close(1e3), 6 * import_core2.Time.second);
    clearInterval(this._heartbeat);
    this.socket.addEventListener("message", async ({ data }) => {
      ...
      } else if (parsed.s === 5 /* reconnect */) {
        this._session_id = void 0;
